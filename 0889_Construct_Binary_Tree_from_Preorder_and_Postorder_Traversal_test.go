...
func TestPreAndPostOrder(t *testing.T) {
	root := &leetcode.Q0889TreeNode{Val: 0}
	curn := root
	curn.Left = &leetcode.Q0889TreeNode{Val: 1}
	curn.Right = &leetcode.Q0889TreeNode{Val: 2}

	curn = root.Left
	curn.Left = &leetcode.Q0889TreeNode{Val: 3}
	curn.Right = &leetcode.Q0889TreeNode{Val: 4}

	curn = root.Right
	curn.Left = &leetcode.Q0889TreeNode{Val: 5}

	curn = root.Left.Left
	curn.Left = &leetcode.Q0889TreeNode{Val: 6}
	curn.Right = &leetcode.Q0889TreeNode{Val: 7}

	curn = root.Right.Left
	curn.Right = &leetcode.Q0889TreeNode{Val: 8}
